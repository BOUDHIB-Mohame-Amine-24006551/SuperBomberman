...
public class MenuController {
    ...
    // ============================================================================
    // ✅ MÉTHODES DE LANCEMENT DE JEU MISES À JOUR AVEC GESTION DES PROFILS
    // ============================================================================

    /**
     * ✅ MÉTHODE MISE À JOUR: Lance le mode 2 joueurs avec profil
     */
    @FXML
    ...
    /**
     * ✅ MÉTHODE MISE À JOUR: Lance le mode bot avec profil
     */
    @FXML
    private void onStartBotGame(ActionEvent event) {
        try {
            String playerName = getPlayerNameForGame();
            if (playerName == null) return; // Annulé
            ...
            if (!difficultyResult.isPresent()) return;
    ...
    /**
     * ✅ MÉTHODE MISE À JOUR: Lance le mode 4 joueurs avec profil
     */
    @FXML
    ...
    // ============================================================================
    // ✅ NOUVELLES MÉTHODES AVEC GESTION DES PROFILS
    // ============================================================================
