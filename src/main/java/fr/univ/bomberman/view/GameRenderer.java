...
public class GameRenderer {
    ...
    private void drawBotIndicators(Game game) {
        ...
        // Indicateur visuel "BOT" au-dessus du bot
        gc.setFill(Color.CYAN);
        gc.setStroke(Color.DARKBLUE);
        gc.setLineWidth(2);
        gc.setFont(javafx.scene.text.Font.font("Arial", javafx.scene.text.FontWeight.BOLD, 10));

        // Fond pour le texte "BOT"
        gc.setFill(Color.DARKBLUE);
        gc.fillRoundRect(pixelX + 5, pixelY - 15, 30, 12, 3, 3);

        // Texte "BOT"
        gc.setFill(Color.CYAN);
        gc.fillText("BOT", pixelX + 8, pixelY - 6);

        // Indicateur de difficulté avec des étoiles
